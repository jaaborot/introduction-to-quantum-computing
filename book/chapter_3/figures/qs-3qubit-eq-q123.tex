...
\draw [->] (node0xx) -- (node00x) node[midway, above left  ] {$1$};                                                           
\draw [->] (node1xx) -- (node11x) node[midway, above right ] {$1$};                                                           
